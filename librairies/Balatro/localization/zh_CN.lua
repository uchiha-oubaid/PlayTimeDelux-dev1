        ...
        Joker = {
            ...
            j_yorick = {
                ...
                text = {
                    "弃牌{C:attention}#2#{}次后",
                    "获得{X:mult,C:white}X#1#{}倍率",
                    "{C:inactive}（剩余弃牌次数：{C:attention}#3#{C:inactive}）"
                },
                unlock = {
                    "{E:1,s:1.3}?????"
                }
            ...
            j_shortcut = {
                ...
                text = {
                    ...
                    "{C:inactive}（例如：{C:attention}1 3 5 7 8{C:inactive}）"
                }
            },
            j_hologram = {
                name = "全息影像",
